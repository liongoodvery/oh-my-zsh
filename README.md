...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/liongoodvery/oh-my-zsh/my/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget https://raw.githubusercontent.com/liongoodvery/oh-my-zsh/my/tools/install.sh -O -)"
```
